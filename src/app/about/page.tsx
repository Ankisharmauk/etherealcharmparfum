      ...
      >
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { num: '01', title: 'Crafted in London', body: 'Every drop is crafted in London using premium, carefully chosen ingredients. Made with precision and care, never compromised.', delay: '0s' },
