...
export async function POST(req: NextRequest) {
  ...
  try {
          ...
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #faf7f2; border: 1px solid #e8d8b0;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
              ...
              <tr>
                ...
                <td style="padding: 10px 0; color: #1a0d02;"><a href="mailto:${email}" style="color: #C9920E;">${email}</a></td>
              </tr>
              <tr>
                <td style="padding: 10px 0; color: #888; vertical-align: top; border-top: 1px solid #e8d8b0;">Message</td>
                <td style="padding: 10px 0; color: #1a0d02; border-top: 1px solid #e8d8b0; white-space: pre-wrap;">${message}</td>
              </tr>
            </table>
            <p style="margin-top: 24px; font-size: 12px; color: #bbb;">Reply directly to this email to respond to ${name}.</p>
          </div>
        `,
      }),
    })
    ...
    if (!res.ok) {
      ...
      console.log('[Contact] Email sent to inbox from:', email)
    }
  } catch (err) {
